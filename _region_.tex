...
\message{ !name(LF+Equality_LCCC.tex) !offset(55) }
...
% What we need is a notion of a \textit{universe} that is closed under composition,
% pullbacks,
...
\message{ !name(LF+Equality_LCCC.tex) !offset(52) }
